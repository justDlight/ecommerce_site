...
import products18 from '../products18.json';
          ...
          <div className="row">
            ...
            <div className="col" id="product-col">
              <div className={styles.grid}>
                {filteredProducts.map(products18 => {
                  return (
                    <div key={products18.id} className={styles.card}>
                      <img src={products18.image} alt={`Preview of ${products18.title}`} />
                      <h3 id="product-title">
                        <a href={`/${products18.title}`}>{ products18.title }</a>
                      </h3>
                      <p id="product-description">{ products18.description }</p>
                      <p id="product-price">${ products18.price }</p>
                      <p>
                        <button id="test_id" className="snipcart-add-item"
                          data-item-id={products18.id}
                          data-item-image={products18.image}
                          data-item-name={products18.title}
                          data-item-url="/"
                          data-item-price={products18.price}
                        >
                          Add to Cart
                        </button>
                      </p>
