...
import products23 from '../products23.json';

export default function Home() {
  const [searchTerm, setSearchTerm] = useState('');

  const filteredProducts = products23.filter(product =>
          ...
          <div className="row">
            ...
            <div className="col" id="product-col">
              <div className={styles.grid}>
                {filteredProducts.map(products23 => {
                  return (
                    <div key={products23.id} className={styles.card}>
                      ...
                      <p>
                        <button id="test_id" className="snipcart-add-item"
                          data-item-id={products23.id}
                          data-item-image={products23.image}
                          data-item-name={products23.title}
                          data-item-url="/"
                          data-item-price={products23.price}
                        >
                          Add to Cart
                        </button>
                      </p>
