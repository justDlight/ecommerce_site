          ...
          <div className="row">
            ...
            <div className="col" id="product-col">
              <div className={styles.grid}>
                {filteredProducts.map(products10 => {
                  return (
                    <div key={products10.id} className={styles.card}>
                      <img src={products10.image} alt={`Preview of ${products10.title}`} />
                      <h3 id="product-title">
                        <a href={`/${products10.title}`}>{ products10.title }</a>
                      </h3>
                      <p id="product-description">{ products10.description }</p>
                      <p id="product-price">${ products10.price }</p>
                      <p>
                        <button id="test_id" className="snipcart-add-item"
                          data-item-id={products10.id}
                          data-item-image={products10.image}
                          data-item-name={products10.title}
                          data-item-url="/"
                          data-item-price={products10.price}
                        >
                          Add to Cart
                        </button>
                      </p>
