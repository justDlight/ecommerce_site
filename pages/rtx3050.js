                ...
                {filteredProducts.map(products14 => {
                  return (
                    <div key={products14.id} className={styles.card}>
                      ...
                      <h3 id="product-title">
                        <a href={`/${products14.title}`}>{ products14.title }</a>
                      </h3>
                      <p id="product-description">{ products14.description }</p>
                      <p id="product-price">${ products14.price }</p>
                      <p>
                        <button id="test_id" className="snipcart-add-item"
                          data-item-id={products14.id}
                          data-item-image={products14.image}
                          data-item-name={products14.title}
                          data-item-url="/"
                          data-item-price={products14.price}
                        >
                          Add to Cart
                        </button>
                      </p>
