...
import products20 from '../products20.json';
          ...
          <div className="row">
            ...
            <div className="col" id="product-col">
              <div className={styles.grid}>
                {filteredProducts.map(products20 => {
                  return (
                    <div key={products20.id} className={styles.card}>
                      <img src={products20.image} alt={`Preview of ${products20.title}`} />
                      <h3 id="product-title">
                        <a href={`/${products20.title}`}>{ products20.title }</a>
                      </h3>
                      <p id="product-description">{ products20.description }</p>
                      <p id="product-price">${ products20.price }</p>
                      <p>
                        <button id="test_id" className="snipcart-add-item"
                          data-item-id={products20.id}
                          data-item-image={products20.image}
                          data-item-name={products20.title}
                          data-item-url="/"
                          data-item-price={products20.price}
                        >
                          Add to Cart
                        </button>
                      </p>
