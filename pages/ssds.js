...
export default function Home() {
  ...
  const filteredProducts = products24.filter(product =>
          ...
          <div className="row">
            ...
            <div className="col" id="product-col">
              <div className={styles.grid}>
                {filteredProducts.map(products24 => {
                  return (
                    <div key={products24.id} className={styles.card}>
                      <img src={products24.image} alt={`Preview of ${products24.title}`} />
                      <h3 id="product-title">
                        <a href={`/${products24.title}`}>{ products24.title }</a>
                      </h3>
                      <p id="product-description">{ products24.description }</p>
                      <p id="product-price">${ products24.price }</p>
                      <p>
                        <button id="test_id" className="snipcart-add-item"
                          data-item-id={products24.id}
                          data-item-image={products24.image}
                          data-item-name={products24.title}
                          data-item-url="/"
                          data-item-price={products24.price}
                        >
                          Add to Cart
                        </button>
                      </p>
